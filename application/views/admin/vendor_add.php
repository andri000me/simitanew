      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
		   <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/action_vendor_add" enctype="multipart/form-data">
            ...
            <div class="box-body">
						...
						<div class="col-lg-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
								 <input type="text" class="form-control" id="alamat_vendor" name="alamat_vendor" placeholder="Input Alamat Vendor.." required/>
                                </div>
                            </div>
                        </div>
