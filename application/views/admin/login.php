...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url(); ?>public/images/Logo_PLN~1.ico"/>
  <title>SIMITA | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
     <img src="<?php echo base_url(); ?>public/images/Logo_PLN.png" height="42" width="32"> <a href="#"><b>PLN</b> STI SUMUT</a>
  </div>
  <!-- /.login-logo -->
