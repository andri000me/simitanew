      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
		   <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/action_vendor_edit?id_vendor=<?php echo $vendornya['id_vendor']; ?>" enctype="multipart/form-data">
            ...
            <div class="box-body">
						...
						<div class="col-lg-10">
                            <div class="form-group">
                                <label for="alamat_vendor" class="col-sm-3 control-label">Alamat</label>
                                <div class="col-sm-5">
								  <input type="text" class="form-control" id="alamat_vendor" name="alamat_vendor" value="<?php echo $vendornya['alamat_vendor']; ?>" required/>
                                 </div>
                            </div>
                        </div>
						<br><br><br>
			...
			<div class="box-footer">
                        <div class="pull-center">
                            ...
                            <a href="<?php echo base_url(); ?>admin/vendor_view" class="btn btn-danger">Kembali</a>
